  ...
  render() {
    return (
        ...
        <p className="About">since you're here I would like to mention that I am extremely excited at an opportunity to work with Solstice. </p>
         <p className="About">I am a passionate and enthusiastic individual who is deeply concerned with environmental conservation; thus, I </p>
         <p className="About">believe that my values line up with Solstice's very well. Renewable energy is humanity's best hope for a positive</p>
        <p className="About">future and I hope that you give me the incredible opportunity to be part of the solution. Thank you! </p>
